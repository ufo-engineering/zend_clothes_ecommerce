<section class="content cart form">
	<div class="block simplePage">
		...
		<div class="head"><h1>404 - Страница не найдена</h1></div>
		...
		print('<ul class="sitemap">');
		print('<li><a href="/">' . $this->translate('Главная страница','Home Page') . '</a></li>');
...
$a404_ga = file_exists('seo/404.txt') ? file_get_contents('seo/404.txt') : '';
